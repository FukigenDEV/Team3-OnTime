package fkg.dev.geofencingdemolast;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GeoQueryEventListener {
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        Toast.makeText(MapsActivity.this, "You must accept permissions!", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    geoFire.setLocation("You", new GeoLocation(locationResult.getLastLocation().getLatitude(),
                        ...
                        public void onComplete(String key, DatabaseError error) {
                            ...
                            currentUser = mMap.addMarker(new MarkerOptions()
                                    ...
                                    .title("You"));
                            //Move camera when marker is placed
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for(LatLng latLng : dangerousArea)
        {
            ...
            //Create GeoQuery when user is in dangerousArea
    ...
    public void onKeyEntered(String key, GeoLocation location) {
        sendNotification("GeofencingDemo",String.format("%s entered the geofence", key));
    }

    @Override
    public void onKeyExited(String key) {
        sendNotification("GeofencingDemo",String.format("%s left the geofence", key));
    }

    @Override
    public void onKeyMoved(String key, GeoLocation location) {
        sendNotification("GeofencingDemo",String.format("%s moved within the geofence", key));
    }
